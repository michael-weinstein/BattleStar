...
class DataLine(object):
    ...
    def __init__(self, rawLine, header, delimiter = "\t"):
        ...
        self.line = self.line.split(delimiter)
        try:
            self.line[self.header.indexOf("pos")] = int(self.line[self.header.indexOf("pos")])
            self.line[self.header.indexOf("ratio")] = float(self.line[self.header.indexOf("ratio")])
            self.line[self.header.indexOf("eff_ct_count")] = int(self.line[self.header.indexOf("eff_ct_count")])
            self.line[self.header.indexOf("c_count")] = int(self.line[self.header.indexOf("c_count")])
            self.line[self.header.indexOf("ct_count")] = int(self.line[self.header.indexOf("ct_count")])
            self.line[self.header.indexOf("rev_g_count")] = int(self.line[self.header.indexOf("rev_g_count")])
            self.line[self.header.indexOf("rev_ga_count")] = int(self.line[self.header.indexOf("rev_ga_count")])
        except ValueError:
            self.isBadLine = True
